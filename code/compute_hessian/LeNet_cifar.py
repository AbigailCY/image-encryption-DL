...
class LeNet(nn.Module):
    def __init__(self):
        ...
        self.weight_conv1 = nn.Parameter(torch.zeros((6, 3, 5, 5)))
        self.bias_conv1 = None

        self.weight_conv2 = nn.Parameter(torch.zeros((16, 6, 5, 5)))
        self.bias_conv2 = None

        self.weight_fc1 = nn.Parameter(torch.zeros((120, 16 * 5 * 5)))
        self.bias_fc1 = None
    ...
    def forward(self, x):
        ...
        self.x_1 = F.relu(self.conv2_pool).view(-1, 16 * 5 * 5)
    ...
    def compute_hessian(self, x):
        ...
        print('conv1_unfold ', conv1_unfold.shape)
        ...
        print('conv2 ', x.shape, conv2_hessian.shape, h_hessian.shape)
