...
if __name__ == '__main__':
    ...
    toSave3 = np.zeros((100,10,4096))
    toSave2 = np.zeros((100,4096,4096))
    toSave1 = np.zeros((100,4096,256))
    toSave4 = np.zeros(100)
    for epoch in range(1, 101):
        ...
        toSave3[epoch-1,:,:] = fc3
        toSave4[epoch-1] = acc
    np.save("./hessian_eigen/AC_fc1.npy", toSave1)
    np.save("./hessian_eigen/AC_fc2.npy", toSave2)
    np.save("./hessian_eigen/AC_fc3.npy", toSave3)
    np.save("./hessian_eigen/AC_acc.npy", toSave4)

    # model.load_state_dict(torch.load('./checkpoint/alexnet_cifar.pkl'))
    # test(model, test_loader) #65.01%
    ...
    torch.save(model.state_dict(), "./checkpoint/alexnet_cifar.pkl")
